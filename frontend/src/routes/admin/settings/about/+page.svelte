	...
	<div class="card p-6">
		<div class="flex items-center justify-between mb-4">
			...
			<div class="flex items-center gap-2">
				...
				<button
					type="button"
					class="p-2 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors disabled:opacity-50"
					onclick={() => forceVersionCheck()}
					disabled={$isCheckingVersion}
					title={$t('admin.about_page.check_for_updates')}
				>
					<svg
						class="w-4 h-4 {$isCheckingVersion ? 'animate-spin' : ''}"
						fill="none"
						viewBox="0 0 24 24"
						stroke="currentColor"
					>
