					...
					<div class="flex items-start gap-4">
						...
						<div class="flex-1 min-w-0">
							...
							<div class="mt-2 flex flex-wrap gap-3">
								...
								{/if}
								{#if talk.slug}
									<a href={getTalkUrl(talk.slug)} aria-label={$t('public.talks.view_details_for', { values: { title: talk.title } })} class="inline-flex items-center gap-1 text-sm text-primary-600 dark:text-primary-400 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-600 dark:focus-visible:ring-primary-400 rounded-sm">
				...
				<article class="card overflow-hidden animate-fade-in">
					...
					{:else}
						<div class="aspect-video bg-gradient-to-br from-indigo-500 to-purple-700 flex items-center justify-center">
							<svg class="w-16 h-16 text-white/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" /></svg>
						</div>
					{/if}
					<div class="p-4">
						<h3 class="font-semibold text-gray-900 dark:text-white">{talk.title}</h3>
					...
					<div class="flex flex-col lg:flex-row">
						...
						{:else}
							<div class="lg:w-2/5 aspect-video bg-gradient-to-br from-indigo-500 to-purple-700 flex-shrink-0 flex items-center justify-center">
								<svg class="w-20 h-20 text-white/50" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" /></svg>
							</div>
						{/if}
						...
						<div class="flex-1 p-6">
							...
							<div class="mt-4 flex flex-wrap gap-3">
								...
								{/if}
								{#if talk.slug}
									<a href={getTalkUrl(talk.slug)} aria-label={$t('public.talks.view_details_for', { values: { title: talk.title } })} class="inline-flex items-center gap-1.5 text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-600 dark:focus-visible:ring-primary-400 rounded-sm">
										{$t('public.talks.view_details')}
										<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
									</a>
								{/if}
