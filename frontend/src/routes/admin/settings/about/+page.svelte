...
<div class="max-w-4xl mx-auto p-6">
	<div class="card p-6">
		...
		<div class="border-t border-gray-200 dark:border-gray-700 pt-6">
			<h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Changelog</h2>
					...
					{#each changelogEntries as entry}
						<div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
							...
							{#if entry.other.length > 0}
								<div class="mb-2">
									<span class="text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase">Other Changes</span>
									<ul class="mt-1 text-sm text-gray-600 dark:text-gray-400 space-y-0.5">
